...
link:../api/pedestal.interceptor/io.pedestal.interceptor.chain.html#execute[`execute`]
...
Or using the interceptor chain link:../api/pedestal.interceptor/io.pedestal.interceptor.chain.html#execute[`execute`]
function:
