...
[source,clojure]
----
include::what-is-an-interceptor/src/service.clj[tags=new_players]
----
...
[source,clojure]
----
include::what-is-an-interceptor/src/service.clj[tags=chooser]
----
...
[source,clojure]
----
include::what-is-an-interceptor/src/service.clj[tags=chooser2]
----
...
[source,clojure]
----
include::what-is-an-interceptor/src/service.clj[tags=error-i]
----
...
[source,clojure]
----
include::what-is-an-interceptor/src/service.clj[tags=error-dispatch]
----
