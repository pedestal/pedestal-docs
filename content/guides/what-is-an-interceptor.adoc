...
[source,clojure]
----
include::what-is-an-interceptor/src/intc/service.clj[tags=start]

include::what-is-an-interceptor/src/intc/service.clj[tags=run_service]
----
...
[source,clojure]
----
include::what-is-an-interceptor/src/intc/service.clj[tags=hello]
----
...
[source,clojure]
----
include::what-is-an-interceptor/src/intc/service.clj[tags=new_players]
----
...
[source,clojure]
----
include::what-is-an-interceptor/src/intc/service.clj[tags=chooser]
----
...
Pedestal routers are just interceptors! A router inspects the incoming request and decides which
interceptors to enqueue. That's it! There's no magic at all in the router. You can build your own
replacement router. For that matter, you can build a secondary router that uses something other than
the request path to dispatch on.
...
[source,clojure]
----
include::what-is-an-interceptor/src/intc/service.clj[tags=chooser2]
----
...
[source,clojure]
----
include::what-is-an-interceptor/src/intc/service.clj[tags=error-i]
----
...
[source,clojure]
----
include::what-is-an-interceptor/src/intc/service.clj[tags=error-dispatch]
----
