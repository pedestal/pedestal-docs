...
You will run a development mode Datomic instance locally in one process,
and run a Pedestal-based server in another.

== Add Datomic to the Project
After downloading and installing the datomic distribution,
follow the directions here to set up your credentials and encrypt them.
...
4. Go to your local datomic folder > config
...
Now point your browser at `http://localhost:8890/` and you will see the thrilling string:
